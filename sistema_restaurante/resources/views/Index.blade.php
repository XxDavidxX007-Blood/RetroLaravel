...
<head>
    ...
    <meta name="description"
        content="Bienvenido a Retro Restaurant, una experiencia culinaria de alta cocina con los ingredientes más exclusivos.">

    <link rel="shortcut icon" type="image/png" href="{{ asset('images/rest.png') }}">
...
<body class="bg-retro-light font-body text-gray-800 scroll-smooth selection:bg-retro-gold selection:text-white">
    ...
    <nav class="bg-retro-light/95 backdrop-blur-md shadow-sm sticky top-0 z-50 border-b border-gray-100 transition-all duration-300">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex justify-between h-16 md:h-24 items-center">
                ...
                <div class="flex items-center gap-2 md:gap-3">
                    ...
                    <span class="font-heading text-xl md:text-3xl text-retro-dark tracking-wide font-semibold">
                        Retro Restaurant
                    </span>
                ...
                <div class="hidden md:flex space-x-10 font-body text-sm tracking-widest uppercase items-center">
                    ...
                    <a href="#inicio"
                        class="text-gray-600 hover:text-retro-gold transition duration-300">
                        Inicio
                    </a>
        ...
        <div id="mobile-menu"
            class="hidden md:hidden bg-white border-t border-gray-100 shadow-md">
            ...
            <div class="px-5 py-4 flex flex-col gap-1 font-body text-sm tracking-widest uppercase">
                ...
                <a href="#inicio"
                    ...
                    <i class="fas fa-home text-retro-gold mr-2 text-xs"></i>
                    Inicio
                ...
                <a href="#menu"
                    ...
                    <i class="fas fa-utensils text-retro-gold mr-2 text-xs"></i>
                    Menú
                ...
                <a href="#nosotros"
                    ...
                    <i class="fas fa-star text-retro-gold mr-2 text-xs"></i>
                    Experiencia
    ...
    <section id="inicio"
        class="relative h-[80vh] overflow-hidden bg-retro-dark flex items-center justify-center">

        <img src="https://images.unsplash.com/photo-1414235077428-338989a2e8c0?auto=format&fit=crop&w=1920&q=80"
            class="absolute inset-0 w-full h-full object-cover opacity-50"
            alt="Ambiente de Alta Cocina">
        ...
        <div class="relative z-10 flex flex-col items-center justify-center text-center px-4 max-w-4xl mx-auto mt-16">
            ...
            <span class="text-retro-gold font-body tracking-[0.3em] uppercase text-sm mb-4">
                Experiencia Gastronómica
            </span>

            <h1 class="text-5xl md:text-7xl font-heading text-white mb-6 font-medium leading-tight">
                El Arte de la <br>
                Alta Cocina
            </h1>
            ...
            <div class="flex gap-6">
                ...
                <a href="#menu"
                    class="bg-retro-gold text-white px-10 py-4 font-body text-sm tracking-widest uppercase hover:bg-retro-goldlight transition duration-300">
    ...
    <section id="menu"
        class="py-24 bg-retro-subtle bg-pattern relative">

        <div class="max-w-7xl mx-auto px-4">

            <div class="text-center mb-20">

                <span class="text-retro-gold font-body tracking-[0.2em] uppercase text-sm mb-3 block">
                    Nuestra Selección
                </span>

                <h2 class="text-4xl md:text-5xl font-heading font-semibold text-retro-dark">
                    PLATOS SIGNATURE
                </h2>
            ...
            <div class="grid md:grid-cols-3 gap-12">
                ...
                <div class="bg-white overflow-hidden food-card group">
                    ...
                    <div class="p-10 text-center">
                        ...
                        <h3 class="font-heading text-2xl mb-2 text-retro-dark">
                            Lomo Filet Mignon
                        </h3>

                        <div class="text-retro-gold font-body tracking-wider mb-4">
                            $45.00
                        </div>

                        <p class="text-gray-500 mb-8 font-body font-light text-sm leading-relaxed">
                            Corte premium sellado a la perfección, acompañado de puré de trufa negra,
                            espárragos glaseados y reducción de vino tinto.
                        </p>

                        <button class="text-xs uppercase tracking-[0.2em] text-retro-dark border-b border-retro-dark pb-1 hover:text-retro-gold hover:border-retro-gold transition">
                            Ordenar Ahora
                        </button>
                ...
                <div class="bg-white overflow-hidden food-card group">
                    ...
                    <div class="p-10 text-center">
                        ...
                        <p class="text-gray-500 mb-8 font-body font-light text-sm leading-relaxed">
                            Salmón del atlántico en costra de hierbas finas, sobre cama de quinoa
                            cítrica y emulsión de maracuyá salvaje.
                        </p>
                ...
                <div class="bg-white overflow-hidden food-card group">
                    ...
                    <div class="p-10 text-center">
                        ...
                        <p class="text-gray-500 mb-8 font-body font-light text-sm leading-relaxed">
                            Ganache de chocolate belga 70%, corazón de frutos rojos y oro comestible,
                            servido con helado de vainilla de Madagascar.
                        </p>
    ...
    <section id="nosotros"
        ...
        <div class="max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-16 items-center">
            ...
            <div class="order-1 md:order-2 px-4 md:px-10">
                ...
                <h2 class="text-4xl md:text-5xl font-heading font-semibold mb-8 text-retro-dark leading-tight">
                    Perfección en<br>
                    cada detalle
                </h2>

                <p class="text-gray-600 font-light leading-relaxed text-base mb-6 font-body">
                    En <strong>Retro Restaurant</strong>, hemos elevado el concepto de la gastronomía clásica
                    a los más altos estándares de la alta cocina internacional.
                    Cada plato es una obra maestra diseñada para deleitar los sentidos.
                </p>

                <p class="text-gray-600 font-light leading-relaxed text-base mb-10 font-body">
                    Seleccionamos meticulosamente ingredientes de temporada de productores locales
                    y técnicas vanguardistas para ofrecerle una experiencia inmersiva e inolvidable
                    en un ambiente de absoluta sofisticación.
                </p>

                <a href="{{ route('login') }}"
                    class="btn-gold-outline px-8 py-3 font-medium hover:shadow-lg transition duration-300 inline-block text-sm tracking-widest uppercase">
        ...
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="grid md:grid-cols-3 gap-12 text-center">
                ...
                <div class="p-6">
                    ...
                    <h3 class="font-heading text-xl mb-3 tracking-wide">
                        Excelencia Culinaria
                    </h3>

                    <p class="text-gray-400 font-light text-sm">
                        Galardonados por nuestra propuesta gastronómica innovadora.
                    </p>
                ...
                <div class="p-6 border-y md:border-y-0 md:border-x border-gray-800">
                    ...
                    <p class="text-gray-400 font-light text-sm">
                        Maridaje perfecto con nuestra exclusiva cava de vinos internacionales.
                    </p>
                ...
                <div class="p-6">
                    ...
                    <p class="text-gray-400 font-light text-sm">
                        Atención personalizada para garantizar una velada perfecta.
                    </p>
    ...
    <footer class="bg-retro-dark text-gray-400 pt-20 pb-10 border-t border-gray-900">
        ...
        <div class="max-w-7xl mx-auto px-4 grid md:grid-cols-4 gap-12">
            ...
            <div>
                ...
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <h4 class="text-white text-xl font-heading tracking-widest">
                        RETRO RESTAURANT
                    </h4>

                </div>

                <p class="text-sm font-body font-light leading-relaxed">
                    La máxima expresión de la gastronomía contemporánea
                    en un ambiente de lujo incomparable.
                </p>

                <div class="flex space-x-5 mt-8">

                    <a href="#" class="text-gray-500 hover:text-retro-gold transition">
            ...
            <div>
                ...
                <h4 class="text-white font-heading text-sm tracking-widest uppercase mb-6">
                    Horarios de Reserva
                </h4>
                ...
                <ul class="space-y-4 text-sm font-body font-light">
                    ...
                    <li class="flex justify-between border-b border-gray-800 pb-2 text-retro-gold">
                        <span>Domingo</span>
                        <span>Cerrado</span>
                    </li>
            ...
            <div>
                ...
                <p class="text-sm font-body font-light mb-4 text-gray-400">
                    Av. de la Elegancia 1234,
                    <br>
                    Distrito Financiero
                </p>

                <p class="text-sm font-body font-light mb-4 text-retro-gold">
                    +1 (800) 555-FINE
                </p>

                <p class="text-sm font-body font-light">
                    reservations@retrorestaurant.com
                </p>
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm font-body font-light">
                    ...
                    <li>
                        <a href="{{ route('login') }}"
                            class="hover:text-retro-gold transition">
        ...
        <div class="border-t border-gray-900 mt-16 pt-8 text-center text-xs font-body font-light tracking-wider">
            ...
            <p>
                &copy; 2026 Retro Restaurant Fine Dining.
