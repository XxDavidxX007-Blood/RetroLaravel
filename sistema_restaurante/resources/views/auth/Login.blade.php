...
<body class="bg-retro-dark min-h-screen flex items-center justify-center p-4 md:p-8 font-body bg-lux relative">
    ...
    <a
        href="{{ url('/') }}"
        class="absolute top-8 left-8 text-white/80 hover:text-retro-gold transition z-10 font-body text-sm tracking-widest uppercase flex items-center gap-3"
    >
    ...
    <div class="glass-panel w-full max-w-6xl shadow-2xl overflow-hidden flex flex-col md:flex-row min-h-[650px] relative z-10">
        ...
        <div class="hidden md:flex md:w-5/12 relative overflow-hidden bg-retro-dark items-center justify-center">
            ...
            <div class="relative z-10 p-12 text-center text-white flex flex-col items-center">
                ...
                <h2 class="text-3xl font-heading tracking-widest uppercase mb-4 text-retro-gold font-bold">
                    Bienvenido
                </h2>
        ...
        <div class="w-full md:w-7/12 p-10 md:p-16 lg:p-20 flex flex-col justify-center bg-white">
            ...
            <div class="text-center mb-12">
                ...
                <h1 class="text-3xl font-heading text-retro-dark mb-2 font-bold">
                    Acceso Exclusivo
                </h1>

                <p class="text-gray-700 font-body font-medium text-sm">
            ...
            <form
                ...
                method="POST"
                class="space-y-8 max-w-md mx-auto w-full"
            >
                ...
                <div class="relative">
                    ...
                    <label class="block text-xs uppercase tracking-[0.2em] text-gray-800 mb-2 font-bold">
                        Correo Electrónico
                    </label>
                ...
                <div class="relative">
                    ...
                    <div class="text-right mt-3">
                        ...
                        <a
                            href="#"
                            class="text-gray-400 hover:text-retro-gold transition text-xs tracking-wider"
                        >
                ...
                <div class="flex items-center pt-2">
                    ...
                    <input
                        ...
                        id="remember"
                        name="remember"
                        class="w-4 h-4 text-retro-gold focus:ring-retro-gold border-gray-300 rounded-sm cursor-pointer accent-retro-gold"
                    >

                    <label
                        for="remember"
                        class="ml-3 block text-xs text-gray-700 font-medium"
                    >
            ...
            <div class="mt-12 text-center pt-8 border-t border-gray-100">
                ...
                <p class="text-gray-700 font-body text-sm font-medium tracking-wide">
                    ...
                    <a
                        href="{{ route('register') }}"
                        class="inline-block mt-4 text-retro-dark border-b-2 border-retro-dark pb-1 text-xs uppercase tracking-[0.2em] font-bold hover:text-retro-gold hover:border-retro-gold transition"
                    >
